...
public class Config {
	...
	public static void createConfig() {
		if (!Murder.configFile.exists()) {
			Murder.instance.getConfig().options().header("Configuration for Murder \nhttp://dev.bukkit.org/bukkit-plugins/murder/ \n\"useBungeeCord\", \"BungeeCordArena\" and \"BungeeCordHubName\" is only required if you want to use this on a BungeeServer!");
			...
			Murder.instance.getConfig().addDefault("BungeeCordArena", Integer.valueOf(1));
			Murder.instance.getConfig().addDefault("BungeeCordHubName", "lobby");
			// Murder.instance.getConfig().addDefault("autoRestart",
